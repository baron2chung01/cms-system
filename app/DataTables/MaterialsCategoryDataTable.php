...
class MaterialsCategoryDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'materials_categories.datatables_actions')
     ...
     *
     * @param \App\Models\MaterialsCategory $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(MaterialsCategory $model)
    {
    ...
    {
        return 'materials_categories_datatable_' . time();
    }
}
