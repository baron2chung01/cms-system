...
class RenovateCourseCategoryDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'renovate_course_categories.datatables_actions')
     ...
     *
     * @param \App\Models\RenovateCourseCategory $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(RenovateCourseCategory $model)
    {
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->minifiedAjax()
            ->addAction(['width' => '120px', 'printable' => false, 'title' => '動作'])
            ->parameters([
    ...
    {
        return 'renovate_course_categories_datatable_' . time();
    }
}
