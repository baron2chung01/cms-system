...
class RenovateCasesDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'renovate_cases.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\RenovateCases $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(RenovateCases $model)
    {
    ...
    {
        return 'renovate_cases_datatable_' . time();
    }
}
